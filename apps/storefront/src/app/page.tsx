...
export default async function HomePage() {
  ...
  const homeCategories = buildHomeCategories(categoryTree)
  const flatCategories = flattenCategoryTree(categoryTree)
  const brandItems = buildBrands(products)

  const totalProducts = categoryTree.reduce(
          ...
          <div className={s.heroStats}>
            <div className={s.heroStat}>
              <span className={s.heroStatNum}>
                {totalProducts > 0 ? totalProducts.toLocaleString('uk-UA') : '—'}
              </span>
            ...
            <div className={s.heroStat}>
              <span className={s.heroStatNum}>
                {totalCategories > 0 ? totalCategories.toLocaleString('uk-UA') : '—'}
              </span>
              <span className={s.heroStatLabel}>Категорій</span>
            </div>

            <div className={s.heroStat}>
              <span className={s.heroStatNum}>{products.length}</span>
