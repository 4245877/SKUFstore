...
const processSteps = [
...

  {
    ...
    text: 'Фігурка виготовляється на фотополімерному принтері та проходить базову підготовку. Якщо обрана послуга складання, закладається додатковий час на ручну роботу.',
