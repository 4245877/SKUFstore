...
const faqItems = [
  {
    ...
    a: 'Набір у деталях надсилається роздільно та краще переносить доставку. Базова збірка і склеювання доступні за погодженням, але це ручна робота: на складних моделях можуть залишатися невеликі технологічні шви або сліди підгонки деталей. Якщо потрібен максимально безпечний варіант доставки, радимо замовляти модель набором у деталях.',
  },
  {
...
export default function DeliveryPage() {
  ...
  const calcPrices: Record<CalcKey, CalcResult> = {
    ...
    'np:assembled': {
      time: '1–3 роб. дні після готовності',
      price: 'за тарифом НП',
      note: 'Рекомендуємо відділення або курʼєра; складання погоджується окремо',
    },
    'ukrposhta:kit': {
    ...
    'international:assembled': {
      time: 'індивідуально',
      price: 'розрахунок перед оплатою',
      note: 'Погоджується окремо; безпечнішим варіантом є набір у деталях',
    },
  };
    ...
    <>
      ...
      <section className={styles.introSection}>
        <div className={styles.introInner}>
          ...
          <h2 className={styles.introTitle}>Виготовлення під замовлення та безпечне відправлення</h2>
          <p className={styles.introSub}>
            Кожна фігурка проходить підготовку перед відправленням. Базова збірка
            і склеювання доступні за погодженням, але це ручна робота, тому для
            максимально безпечної доставки ми радимо формат набору у деталях.
          </p>

          <div className={styles.introBadges}>
            <span className={styles.methodTag}>Виготовлення під замовлення</span>
            <span className={styles.methodTag}>Складання за погодженням</span>
