      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroText}>
            ...
            <p className={styles.heroEyebrow}>Return & exchange</p>
      ...
      <main className={styles.main}>
          ...
          <section className={styles.sectionCard}>
            ...
            <div className={styles.sectionBody}>
              <p>
                ...
                отримання замовлення, якщо товар не був у використанні,
                збережено його товарний вигляд, комплектацію, пакування та
            ...
            <div className={styles.sectionBody}>
              <ol className={styles.stepsList}>
                ...
                <li className={styles.stepsItem}>
                  ...
                  <span className={styles.stepsText}>
                    Додай фото товару, пакування та пошкоджень, якщо вони є.
                  </span>
                </li>
          ...
          <section className={styles.sectionCard}>
            ...
            <div className={styles.sectionBody}>
              <p>
                ...
                доставки. В інших випадках витрати на зворотну доставку може
                оплачувати покупець.
              </p>
            </div>
          </section>
        ...
        <aside className={styles.sidebar} aria-label="Додаткова інформація">
          <section className={styles.contactCard}>
            <p className={styles.contactCardLabel}>Need help</p>
          ...
          <section className={styles.timelineCard}>
            <p className={styles.timelineCardLabel}>Process</p>
          ...
          <section className={styles.policyNote}>
